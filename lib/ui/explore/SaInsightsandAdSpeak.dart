...
import '../../common_widgets/Listtile_widgets/ListileWithHtml.dart';
...
class SaInsightsAdSpeakDetail extends StatefulWidget {
  const SaInsightsAdSpeakDetail({super.key});

  @override
  State<SaInsightsAdSpeakDetail> createState() => _SaInsightsAdSpeakDetailState();
}

class _SaInsightsAdSpeakDetailState extends State<SaInsightsAdSpeakDetail> {

  //"${saudainsgts.IsAdvisorsSpeak}  and ${saudainsgts.IsSaudaInsights}"
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CommonProvider>(
      builder: (context,saudainsgts,child) {
        return  Consumer<ExploreDetailViewModel>(
            builder: (context, expDetaildata, child) {
              return Scaffold(
                appBar: CustomAppBar(height: 60.0, title: saudainsgts.IsSaudaInsights? "Sauda Insights" : "Advisors Speak", appbarclr: Appcolors.white),
             body: saudainsgts.IsSaudaInsights ?
             Padding(
