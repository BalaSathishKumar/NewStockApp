...
class _TabContainersState extends State<TabContainers> {
          ...
          if (!_commonProvider.IsLastPage) {
            ...
            if(widget.IsExplorePage){
              ...
              _exploreViewModel.exploreapi(
                  ...
                  catID: _commonProvider.ExploreCatId,
                  PageNo: pageNo.toString());
            }

          }else if(!_commonProvider.IsVALastPage){
            VApageNo++;
            if(widget.IsTopStocks){
              _exploreViewModel.viewallapi(onFailureRes: onFailureRes, onSuccessRes: onViewallSuccessRes, title: "featured_stocks",pageNo: VApageNo.toString());
            }else if(widget.IsIpo){
              _exploreViewModel.viewallapi(onFailureRes: onFailureRes, onSuccessRes: onViewallSuccessRes, title: "ipo_fpo",pageNo: VApageNo.toString());
            }else if(widget.IsTendingStocks){
              _exploreViewModel.viewallapi(onFailureRes: onFailureRes, onSuccessRes: onViewallSuccessRes, title: "trending_stocks",pageNo: VApageNo.toString());
            }
          }
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CreateListViewModel>(builder: (context, mylistdata, child) {
      addMyListStocks(
          mylistdata.MyListResponseModel?.listings); //add create list stocks
      return (Consumer<DashboardViewModel>(builder: (context, dashdata, child) {
                ...
                return Container(
                  child: Consumer<ExploreViewModel>(
                      builder: (context, expdata, child) {
                        addTopStocks(expdata.ViewAllModel?.data?.stocks); // add top stocks
                    ...
                    return CheckCatlist(expdata.exploreModel?.data?.stocks, expdata.ExploreStocksVM,expdata.ViewallStock) //ExploreStocks
                        ? Container(
                            height: 50,
                            width: devicewidth,
                            //  color: Colors.red,
                        ...
                        : ListView.builder(
                            ...
                            itemCount: widget.IsExplorePage
                                ? expdata.ExploreStocksVM?.length ?? 0 + 1
                                : getItemCount(
                                  ...
                                  //expdata.ViewAllModel?.data?.stocks?.length,
                                expdata.ViewallStock?.length,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              List<Stocks> calist = getCatList(
                                  expdata.exploreModel?.data?.stocks,
                                  expdata.ExploreStocksVM,expdata.ViewallStock);
                             // print('catlist length ${calist[0].name}');
                              if (widget.IsExplorePage) {
                                if (index < expdata.ExploreStocksVM.length) {
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        if (calist != null) {
                                          if (calist[index].listData != null &&
                                              calist[index].listData!.isNotEmpty) {
                                            print(
                                                            ...
                                                            children: [
                                                              Expanded(
                                                                  ...
                                                                  child: Text(
                                                                    ...
                                                                    widget.IsMylisting ? "" : setFirstValue(calist[index].listData),
                                                                    maxLines: 1,
                                                                    overflow: TextOverflow.ellipsis,
                                                                    style: CustomTextStyle.txt12Rbtxtblk,
                                                                  )),
                                                              Expanded(
                                                                  flex: 1,
                                                                  child: Text(
                                                                      //"Lot Size",
                                                                      widget.IsMylisting ? "Status: ${calist[index].statusText}" : setFirstKey(calist[index].listData),
                                                                      maxLines: 1,
                                                                      overflow: TextOverflow.ellipsis,
                                                                      style: widget.IsMylisting ? CustomTextStyle.txt12Rrtxtred : CustomTextStyle.txt12Rrtxtblk)),
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              ...
                                                                              child: Align(
                                                                                ...
                                                                                child: Text("${Constant.rupeeSymbol}${calist[index].buyingPrice}", maxLines: 1, overflow: TextOverflow.ellipsis, style: CustomTextStyle.txt16Rb),
                                                                              ),
                                                                            )),
                                                                            buildSizedBox(
                                                                                height: 0,
                                                                                width: 5),
                                                                            SvgPicture.asset(LocalSVGImages.stockdown,
                                                                                height: 15,
                                                                                width: 15),
                                                                          ],
                                                                        ),
                                                                    ...
                                                                    Expanded(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          overflow:
                                                                              TextOverflow.ellipsis,
                                                                          style:
                                                                              CustomTextStyle.txt14Rrtxtblktxtpurple,
                                                                        )),
                                                                    Expanded(
                                                                      flex: 1,
                                                                      child:
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              ...
                                                                              child: Align(
                                                                                ...
                                                                                child: Text("${Constant.rupeeSymbol} ${calist[index].sellingPrice}", maxLines: 1, overflow: TextOverflow.ellipsis, style: CustomTextStyle.txt14Rrtxtblk),
                                                                              ),
                                                                            )),
                                                                            buildSizedBox(
                                                                                height: 0,
                                                                                width: 5),
                                                                            SvgPicture.asset(LocalSVGImages.stockup,
                                                                                height: 15,
                                                                                width: 15),
                                                                          ],
                                                                        ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Flexible(
                                                                                child: Text(
                                                                                    // "\u20B9${calist?[index].High}" ?? "",
                                                                                    widget.IsMylisting ? "" : setSecondValue(calist[index].listData),
                                                                                    maxLines: 1,
                                                                                    style: CustomTextStyle.txt12Rbtxtgreen),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Flexible(
                                                                                child: Text(
                                                                                    // "High",
                                                                                    widget.IsMylisting ? "" : setSecondKey(calist[index].listData),
                                                                                    maxLines: 1,
                                                                                    overflow: TextOverflow.ellipsis,
                                                                                    textAlign: TextAlign.right,
                                                                                    style: CustomTextStyle.txt12Rrtxtgreen),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Flexible(
                                                                                  child: Text(
                                                                                      // "\u20B9${calist?[index].Low}" ?? "",
                                                                                      widget.IsMylisting ? "" : setThirdValue(calist[index].listData),
                                                                                      style: CustomTextStyle.txt12Rbtxtorange),
                                                                                ),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Flexible(
                                                                                  child: Text(widget.IsMylisting ? "" : setThirdKey(calist[index].listData), maxLines: 1, overflow: TextOverflow.ellipsis, style: CustomTextStyle.txt12Rrtxtorange),
                                                                                ),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(calist?[index].userRating ?? "", style: CustomTextStyle.txt12Rrtxtblk),
                                                                              Icon(
                                                                                Icons.star,
                                                                                color: Colors.yellow,
                                                                                size: 15,
                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      height: 120,
                                      decoration: BoxDecoration(
                                        color: Color(int.parse(calist[index].colorText ?? "0xFFFDF7E8")),
                                        borderRadius: BorderRadius.only(
                                            topLeft: Radius.circular(16),
                                            topRight: Radius.circular(16),
                                            bottomRight: Radius.circular(16),
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                                ...
                                                                child: Text(
                                                                  //"Lot Size",
                                                                    widget.IsMylisting
                                                                        ? "Status: ${calist[index].statusText}"
                                                                        : setFirstKey(
                                                                        calist[index]
                                                                            .listData),
                                                                    maxLines: 1,
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                Align(
                                                                                  alignment: Alignment.bottomRight,
                                                                                  child: Text("${Constant.rupeeSymbol}${calist[index].buyingPrice}",
                                                                                      maxLines: 1,
                                                                                      overflow: TextOverflow.ellipsis,
                                                                                      style: CustomTextStyle.txt16Rb),
                                                                                ),
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child: SvgPicture.asset(LocalSVGImages.stockdown,
                                                                                height: 15,
                                                                                width: 15),
                                                                          ),
                                                                        ],
                                                                          ...
                                                                          Expanded(
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                Align(
                                                                                  ...
                                                                                  child: Text("${Constant.rupeeSymbol} ${calist[index].sellingPrice}",
                                                                                      maxLines: 1,
                                                                                      overflow: TextOverflow.ellipsis,
  ...
  CheckCatlist(List<Stocks>? stocks, List<Stocks>? exploreStocks, List<Stocks>? viewallStock) {
    ...
    if (widget.IsMylisting) {
      ...
      print('widget.IsIpo length ${viewallStock?.length}');
      if (viewallStock != null && viewallStock!.isEmpty) {
        return true;
      } else {
        return false;
      }
    } else if (widget.IsTopStocks) {
      print('widget.IsTopStocks length ${viewallStock?.length}');
      if (viewallStock != null && viewallStock.isEmpty) {
        return true;
      } else {
        return false;
      ...
      print('widget.IsTendingStocks length ${viewallStock?.length}');
      if (viewallStock != null && viewallStock.isEmpty) {
        return true;
      } else {
        return false;
  ...
  void addTopStocks(List<VAStocks>? TopStocks) {
    print('TopStocks1 ${TopStocks?.length}');
    if (TopStocks != null && TopStocks.isNotEmpty) {
      //print('TopStocks lenth n fun ${TopStocks.length}');
      HomeTopStocks?.clear();
     // HomeTopStocks?.addAll(TopStocks);
      print('TopStocks2 ${HomeTopStocks?.length}');
      for (VAStocks topstockdata in TopStocks ?? []) {
        var topstkdata = topstockdata.stock!;
        if (topstkdata != null) {
          HomeTopStocks?.add(topstkdata);
         // print('TopStocks3 ${HomeTopStocks?[0].name}');
        }
      }
    }
  }
    ...
    if (TrendStocks != null && TrendStocks.isNotEmpty) {
      ...
      for (FDataa trendstocks in TrendStocks ?? []) {
        if (trendstocks.stock != null) {
          ...
          // print('TrendingStocks colors ${TrendingStocks?[0].colorText ?? ""}');
        }
      }
    }
  }
  ...
  getCatList(List<Stocks>? stocks, List<Stocks>? exploreStocksVM, List<Stocks>? viewallStock) {
    if (widget.IsFavorite) {
      return favstocks;
    } else if (widget.IsMylisting) {
