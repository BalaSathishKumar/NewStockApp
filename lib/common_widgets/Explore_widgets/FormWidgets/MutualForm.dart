...
class MutualForm extends StatefulWidget {
  ...
  @override
  State<MutualForm> createState() => _MutualFormState();
}

class _MutualFormState extends State<MutualForm> {
  ...
  TextEditingController _sipandLumpsumcontroller = TextEditingController();
  ...
  void initState() {
    ...
    print('Buy Sell Selected stock name  ${_selectedstocks?.categoryButtons?.length} id ${_selectedstocks?.id} catid ${_selectedstocks?.categoryId.toString()}');
    _sipandLumpsumcontroller = TextEditingController(text: _commonProvider.ShareQty);
  }
                      ...
                      child: Column(
                        ...
                        //    color: Colors.red.shade100,
                            child: ListView.builder(
                                ...
                                itemCount: _selectedstocks?.categoryButtons?.length ?? 0,
                                  ...
                                  return Padding(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          ...
                                          border: Border.all(color:  Appcolors.quickstatsgrey,)
                                      ),
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child:   Text(_selectedstocks?.categoryButtons?[index].buttonName ?? "",
                                                style: TextStyle(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  Text("- OR -"),
                                  SizedBox(height: 16,),
                                  Text("Invest at ease with free & full assistance from top Mutual Fund Distributors",style: CustomTextStyle.txt16Rb400gry,),
                                ],
                              ),
                            ),
                          ),
                          ...
                          SizedBox(height: 16,),
                          NumOfShare(devicewidth, _sipandLumpsumcontroller,"SIP/ Lumpsum Amount (if any)",'Ex: 500',true),
                       /*   SizedBox(height: 16,),
                                       ...
                                       //   width: 190,
                                          ...
                                          "price":500 ---   */
                                              ...
                                              Map<String, dynamic> buysellparam = {
                                                ...
                                                "guidance": true,
                                                "price": "0",
                                                "lumpsum_amount":"${_commonProvider.SipLumpsum}"
                                              };
          ...
          children: [
            ...
            Container(
              ...
              child: CustomOutlinedTextField(
                ...
                onChanged: (value) {
                  _commonProvider.setSipLumpsum(value);
                },
